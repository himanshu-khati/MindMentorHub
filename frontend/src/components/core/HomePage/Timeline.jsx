...
const Timeline = () => {
  return (
    <div className="flex w-11/12 mx-auto max-w-maxContent flex-col lg:flex-row gap-20 mb-20 items-center">
        ...
        {TIMELINE.map((timeLineData, index) => {
          return (
            <div key={timeLineData.Heading} className="flex flex-col lg:gap-3">
              ...
              <div
                className={`h-14 border-dotted border-r border-richblack-100 bg-richblack-400/0 w-6 ${
